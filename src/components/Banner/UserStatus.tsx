...
export default function UserStatus(props: Props) {
    ...
    const [subscribeKeyword, setsubscribeKeyword] = useState(props.subscribeKeywordCount)
                ...
                <div className='banner__user__info'>
                    ...
                    >
                        ...
                        <img
                            ...
                            onMouseEnter={() => { setProfileImageMouse(true) }}
                            onMouseLeave={() => { setProfileImageMouse(false) }}
                    ...
                    <div className='banner__user__status__box'>
                        ...
                        <div style={{ display: "flex", flex: "0 0 100%", flexDirection: 'row' }}>
                            <div className='banner__user__status'>
                                <div className='banner__user_status__info'><p>구독한 키워드 : {subscribeKeyword}</p></div>
                                <div className='banner__user_status__info'><p>{props.age}</p></div>
                            </div>
                            <div className='banner__user__status' >
                                <div className='banner__user_status__info'><p>대표 키워드 : </p></div>
                                <div className='banner__user_status__info'><p>{props.gender === 'man' ? "남자" : props.gender === 'woman' ? '여자' : '선택안함'}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
